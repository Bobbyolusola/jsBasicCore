...
// console.log(numbers.shift());// shows the first digits of numbers
// console.log(numbers);// removed the first digits of numbers
//
// console.log(numbers.pop());// shows the last digits of numbers
// console.log(numbers);// removes the last digits of numbers
...
// console.log(numbers.slice( 1,  -3)) // slices from the right counts of 3 starting from 1 and not 0
...
// 3. Write the getLength(arr) function, which accepts an array arr of names and returns a new array with the length of the elements of those names:
...
// arr =  (['Ivan', 'Pavlo', 'Ira']);
// arr1 = arr.getLength = (['Ivan', 'Pavlo', 'Ira']);
// console.log(arr1);


//4.Write a function removeDuplicates(arr) that accepts an array arr from names and returns a new array where duplicate elements from the array arr are excluded (ignore case sensitivity):
